$(document).ready(function(){
	...
	$(".content li").hover(function() {
		...
		if(index == 0) {
			$(".content li div img")[0].src = "../img/11.png";
		}
	}, function() {
		$(".content li div img")[0].src = "../img/1.png";
	})
	$(".content li").hover(function() {
		var index = $(this).index();
		if(index == 1) {
			$(".content li div img")[1].src = "../img/22.png";
		}
	}, function() {
		$(".content li div img")[1].src = "../img/2.png";
	})
	$(".content li").hover(function() {
		var index = $(this).index();
		if(index == 2) {
			$(".content li div img")[2].src = "../img/33.png";
		}
	}, function() {
		$(".content li div img")[2].src = "../img/3.png";
	})
	$(".content li").hover(function() {
		var index = $(this).index();
		if(index == 3) {
			$(".content li div img")[3].src = "../img/44.png";
		}
	}, function() {
		$(".content li div img")[3].src = "../img/4.png";
	})
	$(".content li").hover(function() {
		var index = $(this).index();
		if(index == 4) {
			$(".content li div img")[4].src = "../img/55.png";
		}
	}, function() {
		$(".content li div img")[4].src = "../img/5.png";
	})
	$(".content li").hover(function() {
		var index = $(this).index();
		if(index == 5) {
			$(".content li div img")[5].src = "../img/66.png";
		}
	}, function() {
		$(".content li div img")[5].src = "../img/6.png";
	})
